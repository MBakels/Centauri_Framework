...
private:
	...
	bool _keys[GLFW_KEY_LAST]; // keys down
	bool _keysUp[GLFW_KEY_LAST]; // Keys released
	bool _keysDown[GLFW_KEY_LAST]; // Keys pressed

	bool _mouse[GLFW_MOUSE_BUTTON_LAST]; // Mouse down
	bool _mouseUp[GLFW_MOUSE_BUTTON_LAST]; // Mouse released
	bool _mouseDown[GLFW_MOUSE_BUTTON_LAST]; // Mouse pressed
